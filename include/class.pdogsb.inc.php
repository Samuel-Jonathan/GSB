...
class PdoGsb
{
	...
	public function getVisiteursID($nom, $prenom)
	{
		$req = "select visiteur.id FROM visiteur WHERE visiteur.nom='" . $nom . "' AND visiteur.prenom='" . $prenom . "';";
		$rs = PdoGsb::$monPdo->query($req);
		$ligne = $rs->fetch();
		return $ligne;
	}
	...
	{
		$req = "select visiteur.id as id, visiteur.nom as nom, visiteur.prenom as prenom, visiteur.role from visiteur 
